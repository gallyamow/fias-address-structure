...
class ObjectAddressLevelSpecResolver implements ObjectAddressLevelSpecResolverInterface
{
    ...
    private const VARIANTS = [
        ...
        [
            ...
            'shortName' => 'тер.',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер.', 'тер'], 'levels' => [2, 5, 6, 7, 8, 14, 15, 16]]],
        ],
        [
            'name' => 'территория ГСК',
            'shortName' => 'тер. ГСК',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ГСК'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория дачных некоммерческих объединений граждан',
            'shortName' => 'тер. ДНО',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ДНО'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория дачных некоммерческих партнерств',
            'shortName' => 'тер. ДНП',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ДНП'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория дачных некоммерческих товариществ',
            'shortName' => 'тер. ДНТ',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ДНТ'], 'levels' => [8]]],
        ],
        [
            'name' => 'территория дачных потребительских кооперативов',
            'shortName' => 'тер. ДПК',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ДПК'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория огороднических некоммерческих объединений граждан',
            'shortName' => 'тер. ОНО',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ОНО'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория огороднических некоммерческих партнерств',
            'shortName' => 'тер. ОНП',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ОНП'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория огороднического некоммерческого товарищества',
            'shortName' => 'тер. ОНТ',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ОНТ'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория огороднических потребительских кооперативов',
            'shortName' => 'тер. ОПК',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ОПК'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория потребительского кооператива',
            'shortName' => 'тер. ПК',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ПК'], 'levels' => [7]]],
        ],
        [
            'name' => 'Территория садоводческих некоммерческих объединений граждан',
            'shortName' => 'тер. СНО',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. СНО'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория садоводческих некоммерческих партнерств',
            'shortName' => 'тер. СНП',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. СНП'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория садоводческих некоммерческих партнерств',
            'shortName' => 'тер. СНТ',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. СНТ'], 'levels' => [7, 8]]],
        ],
        [
            'name' => 'территория ведения гражданами садоводства или огородничества для собственных нужд',
            'shortName' => 'тер. СОСН',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер.СОСН', 'тер. СОСН'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория садоводческих потребительских кооперативов',
            'shortName' => 'тер. СПК',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. СПК'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория товарищества собственников жилья',
            'shortName' => 'тер. ТСЖ',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ТСЖ'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория товарищества собственников недвижимости',
            'shortName' => 'тер. ТСН',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер. ТСН'], 'levels' => [7]]],
        ],
        [
            'name' => 'территория ФХ',
            'shortName' => 'тер. ФХ.',
            'namePosition' => AddressLevelSpec::NAME_POSITION_BEFORE,
            'variants' => [['names' => ['тер.ф.х.'], 'levels' => [7]]],
        ],
